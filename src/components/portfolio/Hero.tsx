      ...
      >
        <div>
          ...
          >
            <a
              href="#projects"
              className="group relative inline-flex items-center gap-2 rounded-lg border border-[color:var(--neon)] bg-[color:color-mix(in_oklab,var(--neon)_15%,transparent)] px-5 py-3 font-mono text-xs uppercase tracking-[0.18em] text-neon glow-ring transition hover:bg-[color:color-mix(in_oklab,var(--neon)_25%,transparent)]"
            >
              <Code2 className="h-4 w-4" /> See my work
            </a>
            <a
              href="#about"
              className="inline-flex items-center gap-2 rounded-lg border border-border/60 px-5 py-3 font-mono text-xs uppercase tracking-[0.18em] text-foreground/80 hover:border-[color:var(--neon-2)] hover:text-magenta"
            >
          ...
          >
            <Stat k="Experience" v="6+ years" />
            <Stat k="Projects" v="25+ shipped" />
