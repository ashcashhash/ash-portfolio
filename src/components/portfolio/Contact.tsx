...
const LINKS = [
  { icon: Mail, label: "hello@ashnish.dev", href: "mailto:hello@ashnish.dev" },
  { icon: Github, label: "github.com/ashnish", href: "#" },
  { icon: Linkedin, label: "linkedin.com/in/ashnish", href: "#" },
  { icon: Music2, label: "soundcloud.com/ashnish", href: "#" },
];
  ...
  return (
    ...
    >
      <div className="panel relative overflow-hidden p-8 md:p-12">
        ...
        <div className="absolute -bottom-24 -left-24 h-72 w-72 rounded-full blur-3xl"
        ...
        <div className="relative grid grid-cols-1 items-center gap-8 md:grid-cols-2">
          <div>
            ...
            <p className="mt-3 max-w-md text-muted-foreground">
              Open to senior &amp; staff engineering roles, advisory work, and small creative builds. I usually reply within a day.
            </p>
            <a
              href="mailto:hello@ashnish.dev"
      ...
      <footer className="mt-16 flex flex-col items-center justify-between gap-3 border-t border-border/40 pt-6 font-mono text-[10px] uppercase tracking-widest text-muted-foreground md:flex-row">
        <span>© {new Date().getFullYear()} Ashnish · Built with care &amp; React</span>
        <span>Made with music on</span>
      </footer>
    </Section>
  );
}
